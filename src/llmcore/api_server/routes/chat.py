...
async def handle_chat(request: Request, chat_request: ChatRequest) -> Union[ChatResponse, StreamingResponse]:
    """
    ...
    try:
        ...
        logger.debug(f"Calling LLMCore.chat with params: {list(chat_params.keys())}")

        # Call the LLMCore chat method
