# src/llmcore/api_server/models/core.py
"""
Core Pydantic models for the llmcore API server.

This module defines the request and response models for the core API endpoints,
moved from the original models.py file to support the new models directory structure.
"""
