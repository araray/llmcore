...
def check_manager_workflow() -> List[Tuple[str, bool, str]]:
    ...
    try:
        ...
        async def test_disabled():
            return await disabled_manager.check_approval(
                "bash_exec",
                {"command": "rm -rf /"}
            )
...
def check_integration() -> List[Tuple[str, bool, str]]:
    ...
    try:
        ...
        has_hitl_param = any(
            "hitl" in p.lower() or "approv" in p.lower()
