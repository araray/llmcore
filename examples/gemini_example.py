...
if not os.environ.get("LLMCORE_PROVIDERS__GEMINI__API_KEY") and \
   not os.environ.get("GOOGLE_API_KEY"): # SDK also checks GOOGLE_API_KEY
    logger.warning(
...
async def main():
    ...
    rag_documents = [
        {"id": "gemini_doc_1", "content": "Gemini is a family of multimodal large language models developed by Google AI.", "metadata": {"source": "gemini_example"}},
        {"id": "gemini_doc_2", "content": "The Gemini 1.5 Pro model features a large context window, up to 1 million tokens.", "metadata": {"source": "gemini_example"}},
    ]
    ...
    try:
        ...
        async with await LLMCore.create() as llm:
            ...
            try:
                ...
                except (ProviderError, ConfigError, ContextLengthError, VectorStorageError, EmbeddingError) as e:
